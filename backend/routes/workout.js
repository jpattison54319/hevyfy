...
try {
    const response = await openai.chat.completions.create({
      ...
      messages: [
        { 
          role: "system", 
          content: `You are an exercise scientist and evidence based certified strength and conditioning coach. Create a workout routine based off user choices. 
          Use only the equipment that best meets the users goal, ignore the rest. If any physical considerations, plan accordingly. 
